...
public partial class MainWindow : Window
{
    ...
    private void OnInstall(object s, RoutedEventArgs e)
    {
        ...
        Task.Run(() =>
        {
            Action<string> log = msg => Dispatcher.UIThread.Invoke(() => SetStatus(msg, "Accent"));
    ...
    private void OnRestore(object s, RoutedEventArgs e)
    {
        ...
        Task.Run(() => CameraMod.RestoreCamera(gameDir,
            log: msg => Dispatcher.UIThread.Invoke(() => SetStatus(msg, "Accent"))))
            .ContinueWith(t =>
            {
                Dispatcher.UIThread.Invoke(() =>
                {
    ...
    private void CheckForUpdate()
    {
        ...
        catch { BannerPanel.IsVisible = false; }
    }
